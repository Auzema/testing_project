...
String title = "Katalon Article ${runId}"
String description = "Article generated by Katalon automation"
String body = "This article was created by Katalon automation.\n\nTimestamp: ${runId}"
String tag = "qatag${runId}"
...
try {
    ...
    WebUI.verifyTextPresent(body.split('\\n')[0], false)
    WebUI.verifyElementVisible(xpath('Article tag', "//li[contains(@class,'tag-pill') and normalize-space()='${tag}']"))
} finally {
    WebUI.closeBrowser()
}
