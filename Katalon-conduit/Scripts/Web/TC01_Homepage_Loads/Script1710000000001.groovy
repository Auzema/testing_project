...
try {
    ...
    WebUI.verifyElementVisible(xpath('Sign up nav', "//a[normalize-space()='Sign up']"))
    WebUI.verifyElementVisible(xpath('Global Feed tab', "//a[normalize-space()='Global Feed']"))
    WebUI.verifyElementVisible(xpath('Popular Tags label', "//*[normalize-space()='Popular Tags']"))
    WebUI.waitForElementVisible(xpath('Article list state', "//*[contains(@class,'article-preview')]"), timeout)
} finally {
    WebUI.closeBrowser()
}
